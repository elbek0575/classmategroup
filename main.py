...
birthdays = [
    {"id": 1, "name": "Бозорова Ферузахон", "date": "27 декабря"},
    {"id": 2, "name": "Курбонова Мунаввар", "date": "15 март"},
    {"id": 3, "name": "Азимова Лобархон", "date": "31 август"},
    {"id": 4, "name": "Нурмаматова Лобарой", "date": "30 апрель"},
    {"id": 5, "name": "Темирова Машхурахон", "date": "29 апрель"},
    {"id": 6, "name": "Умаров Жасурбой", "date": "31 март"},
    {"id": 7, "name": "Рахмонов Фаррухжон", "date": "6 март"},
    {"id": 8, "name": "Давронова Нафисахон", "date": "12 ноябрь"},
    {"id": 9, "name": "Кодирова Холидахон", "date": "5 декабрь"},
    {"id": 10, "name": "Жумаева Диличка", "date": "1 ноябрь"},
    {"id": 11, "name": "Мухторова Мохичехра", "date": "23 июль"},
    {"id": 12, "name": "Асадова Гулнора", "date": "19 май"},
    {"id": 13, "name": "Турсунбоев Муроджон", "date": "31 август"},
    {"id": 14, "name": "Абдуллаев Отабек", "date": "30 август"},
    {"id": 15, "name": "Маматов Санжар", "date": "8 февраль"},
    {"id": 16, "name": "Аюбов Элбек", "date": "22 август"},
    {"id": 17, "name": "Аминов Дилшоджон", "date": "10 август"},
    {"id": 18, "name": "Муминов Исроилжон", "date": "14 январь"},
    {"id": 19, "name": "Аслиддинова Навбахор", "date": "29 март"},
    {"id": 20, "name": "Гулбоев Бобир", "date": "28 февраль"},
    {"id": 21, "name": "Сохибов Сирожбой", "date": "19 август"},
    {"id": 22, "name": "Нарзуллаева Гулибахор", "date": "23 апрель"},
    {"id": 23, "name": "Маматов Элёржон", "date": "06 декабрь"},
    {"id": 24, "name": "Камолова Мохигул", "date": "25 март"},
    {"id": 25, "name": "Худоёрова Малика", "date": "24 март"},
    {"id": 26, "name": "Сабриддинова Шахло", "date": "21 декабрь"},
    {"id": 27, "name": "Аминова Мунира", "date": "19 октябрь"},
    {"id": 28, "name": "Нарзуллаев Жамшид", "date": "19 январь"},
    {"id": 29, "name": "Сатторов Отабек", "date": "16 октябрь"},
    {"id": 30, "name": "Ахмедов Хусниддин", "date": "28 январь"},
]


congratulations_1 = f"Азиз дўстим {{name}}!\nТаваллуд кунинг муборак бўлсин! Ёшингда янги марралар, янги ютуқлар сенга ёр бўлсин! Ҳар кунинг қувонч ва бахтга тўлсин! 😊🎉"
...
congratulations_7 = f"Қадрли {{name}}, таваллуд кунинг муборак! Ҳар бир кунинг қувонч, бахт ва соғлиқ билан тўлсин. Сен билан бирга бахтли онларни ўтказиш — биз учун бахт! 💐😊"
...
congratulations_9 = f"Азиз дўстим {{name}}! Бугунги кунда сенга энг эзгу тилакларни тилайман. Ҳар бир орзу ва мақсадларинг амалга ошсин! 🎉❤️"
congratulations_10 = f"Дўстим {{name}}, таваллуд кунинг муборак! Соғлиқ, бахт ва ғалабалар сенга ёр бўлсин! Бизни ҳар доим илҳомлантириб тур! 🌺🌞"
...
congratulations_12 = f"Қимматли {{name}}, бугунги кун сен учун янги бошланғич бўлсин. Ҳар бир кунингда янги имкониятлар ва қувончлар ёр бўлсин! Таваллуд кунинг муборак! 🎉🌈"
congratulations_13 = f"Сендай дўстга эга бўлиш биз учун бахт! {{name}}, таваллуд кунинг муборак бўлсин! Куч-қувват ва илҳом билан тўлиб, орзу қилаётган барча нарсаларингга етиш! 💫🎂"
...
congratulations_15 = f"Азиз {{name}}, янги йилингда янги ғоялар ва имкониятлар яратишда давом эт! Ҳар қадамиингга омад ва муваффақият ёр бўлсин! 🎂🌹"
...
congratulations_17 = f"Қадрли {{name}}, бу йил сен учун энг ютуқли йил бўлсин! Бошланган йўлингда тўхтамай давом эт, барча орзуларинг амалга ошсин! 🌠🎉"
...
congratulations_19 = f"Азиз дўстим {{name}}, орзу-қувончлар билан тўлиб-тошган йил бўлсин! Таваллуд кунинг қутлуғ бўлсин, ҳар кунингда янги имкониятлар ёр бўлсин! 🌻🌈"
...
congratulations_24 = f"Қадрли {{name}}, ҳаётингда ҳар қадамда янги ғалабалар ва ютуқлар сени кутсин! Янги йилингда севинч ва бахтдан чарчамагин! Таваллуд кунинг муборак! 🌼💫"
...
congratulations_27 = f"Қимматли {{name}}, янги йилингда ҳар кун қувонч ва ғалабаларга бой бўлсин! Барча орзуларинг тўлиқ амалга ошсин! Таваллуд кунинг муборак! 🌻❤️"
...
congratulations_30 = f"Қимматли {{name}}, янги йилингда янги юқориликларга етиш! Сенга соғлик, бахт ва доимий қувонч тилайман. Таваллуд кунинг билан! 🌟🌷"
...
congratulations_32 = f"Қадрли {{name}}, сенга меҳр ва муҳаббат билан тўла ҳаёт тилайман. Ҳар бир орзуинг амалга ошсин! Таваллуд кунинг билан! 🎈💖"
...
congratulations_36 = f"Қимматли {{name}}, ҳаётингдаги ҳар кун янги имкониятлар ва илҳомларга тўла бўлсин! Таваллуд кунинг муборак! 🎉🌻"
...
congratulations_42 = f"Қадрли {{name}}, сенга ҳар доим орзуларингга эришиш тилайман! Ҳаётингда қувонч ва омад ёр бўлсин! Таваллуд кунинг билан! 🌹🌸"
...
congratulations_47 = f"Дўстим {{name}}, сенга енгиллик ва муваффақиятлар тилайман! Ҳар бир орзуингга эришишга насиб қилсин! 🎂✨"
...
congratulations_61 = f"Дўстим {{name}}, сенга янги қувончли ва бахтли йил тилайман. Таваллуд кунинг муборак! 🌺✨"
...
def send_congratulation_message(name):
    ...
    logger.info(f"Отправлено поздравление {name}: {message}")
